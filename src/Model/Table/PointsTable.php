...
class PointsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->integer('all_points')
            ->requirePresence('all_points', 'create')
            ->notEmptyString('all_points');

        $validator
            ->integer('sum_points')
            ->requirePresence('sum_points', 'create')
            ->notEmptyString('sum_points');

        $validator
            ->numeric('avg_points')
            ->requirePresence('avg_points', 'create')
            ->notEmptyString('avg_points');
