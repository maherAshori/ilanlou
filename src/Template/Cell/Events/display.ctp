        ...
        <div class="row events_row">
            ...
            <div class="col-lg-4 event_col">
                <div class="event">
                    ...
                    <div class="event_date d-flex flex-column align-items-center justify-content-center" title="<?= $this->cell("ConvertDate", [$event->creation, 'y']) ?>">
                        <div class="event_day">
                            <?= $this->cell("ConvertDate", [$event->creation, 'd']) ?>
                        </div>
                        <div class="event_month">
                            <?= $this->cell("ConvertDate", [$event->creation, 'm']) ?>
                        </div>
                    </div>
